...
BASE_CONF = {
    ...
    "sasl.username": config.ethereum_username,
    "sasl.password": config.ethereum_password,
    "auto.offset.reset": "latest",
    "enable.auto.commit": False,  
    "group.id": f"{config.ethereum_username}-group-{group_id_suffix}",
...
def process_batch(batch_msgs):
    ...
    """
    tx_block = dex_block_message_pb2.DexBlockMessage()
    ...
    for message in batch_msgs:
        ...
        try:
            ...
            logging.info("New DexBlockMessage received:")
            print_protobuf_message(tx_block, encoding='hex')
