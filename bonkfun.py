...
JSON_DUMP_INTERVAL_SECONDS = 30
JSON_LOG_FILE = "token_detections.json"
...
def periodic_log_writer():
    while True:
        time.sleep(JSON_DUMP_INTERVAL_SECONDS)
        with message_log_lock:
            ...
            try:
                ...
                logging.exception("Failed to write message log to JSON")
...
def run_bot():
    ...
    threading.Thread(target=periodic_log_writer, daemon=True).start()
    message_consumer()
